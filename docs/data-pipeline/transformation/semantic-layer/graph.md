...
- **Approved metrics**: 1383 / 1642 total
- **Cross-sector relationships**: 732 total across 13 axes
...
flowchart TB
    ...
    subgraph sg_execution["execution"]
        ...
        api_execution_circles_v2_pool_explorer_liquidity_daily["circles_v2_pool_explorer_liquidity_daily"]
        api_execution_circles_v2_pool_explorer_liquidity_events["circles_v2_pool_explorer_liquidity_events"]
        api_execution_circles_v2_pool_explorer_swaps["circles_v2_pool_explorer_swaps"]
        api_execution_circles_v2_pool_explorer_swaps_daily["circles_v2_pool_explorer_swaps_daily"]
        api_execution_circles_v2_pool_search["circles_v2_pool_search"]
        api_execution_circles_v2_pools_daily["circles_v2_pools_daily"]
        api_execution_circles_v2_pools_latest["circles_v2_pools_latest"]
        api_execution_circles_v2_pools_reserves_daily["circles_v2_pools_reserves_daily"]
        api_execution_circles_v2_pools_reserves_latest["circles_v2_pools_reserves_latest"]
        api_execution_circles_v2_pools_reserves_token_daily["circles_v2_pools_reserves_token_daily"]
        api_execution_circles_v2_pools_traders_daily["circles_v2_pools_traders_daily"]
        ...
        int_execution_gpay_accounts_deployed["gpay_accounts_deployed"]
    ...
    api_execution_account_profile_latest -- address --- int_execution_gpay_accounts_deployed
    ...
    api_execution_circles_v2_pool_explorer_liquidity_daily -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pool_explorer_liquidity_events -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pool_explorer_swaps -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pool_explorer_swaps_daily -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pool_search -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pools_daily -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pools_latest -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pools_reserves_daily -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pools_reserves_latest -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pools_reserves_token_daily -- pool --- stg_pools__v3_pool_registry
    api_execution_circles_v2_pools_traders_daily -- pool --- stg_pools__v3_pool_registry
...
| `address` | `gen_address__api_execution_account_search_index__address__to__api_execution_account_profile_latest` | `account_search_index` → `account_profile_latest` | candidate |
...
| `address` | `gen_address__api_execution_circles_v2_gcrc_cashback_recipients_ranking__address__to__api_execution_account_profile_latest` | `circles_v2_gcrc_cashback_recipients_ranking` → `account_profile_latest` | candidate |
| `address` | `gen_address__api_execution_circles_v2_group_explorer_profile__owner__to__api_execution_account_profile_latest` | `circles_v2_group_explorer_profile` → `account_profile_latest` | candidate |
| `address` | `gen_address__api_execution_circles_v2_group_explorer_profile__treasury_address__to__api_execution_account_profile_latest` | `circles_v2_group_explorer_profile` → `account_profile_latest` | candidate |
...
| `address` | `gen_address__int_execution_gpay_accounts_deployed__account__to__api_execution_account_profile_latest` | `gpay_accounts_deployed` → `account_profile_latest` | candidate |
...
| `circles_avatar` | `gen_circles_avatar__api_execution_circles_v2_group_explorer_profile__invited_by__to__api_execution_circles_v2_avatars_current` | `circles_v2_group_explorer_profile` → `circles_v2_avatars_current` | candidate |
...
| `pool` | `gen_pool__api_execution_circles_v2_pool_explorer_liquidity_daily__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pool_explorer_liquidity_daily` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pool_explorer_liquidity_events__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pool_explorer_liquidity_events` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pool_explorer_swaps__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pool_explorer_swaps` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pool_explorer_swaps_daily__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pool_explorer_swaps_daily` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pool_search__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pool_search` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pools_daily__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pools_daily` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pools_latest__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pools_latest` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pools_reserves_daily__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pools_reserves_daily` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pools_reserves_latest__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pools_reserves_latest` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pools_reserves_token_daily__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pools_reserves_token_daily` → `pools__v3_pool_registry` | candidate |
| `pool` | `gen_pool__api_execution_circles_v2_pools_traders_daily__pool_address__to__stg_pools__v3_pool_registry` | `circles_v2_pools_traders_daily` → `pools__v3_pool_registry` | candidate |
...
| `validator` | `gen_validator__api_consensus_validators_explorer_members_table__validator_index__to__api_consensus_validators_status_latest` | `consensus_validators_explorer_members_table` → `consensus_validators_status_latest` | candidate |
